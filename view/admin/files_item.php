...
<td align="center">
	<a href="#newversion" title="<?php _e ('New version', 'drain-hole'); ?>" onclick="return new_version (<?php echo $file->id ?>,this)"><img src="<?php echo $this->url () ?>/images/add.png" width="16" height="16" alt="Add"/></a>
	<a href="#newversion" title="<?php _e ('New version', 'drain-hole'); ?>" onclick="return new_version (<?php echo $file->id ?>,this)">new</a>
</td>
<td align="center">
	<a href="<?php echo $this->base () ?>?page=drain-hole.php&amp;source=hole&amp;chart=<?php echo $file->id ?>"><img src="<?php echo $this->url () ?>/images/chart.png" width="16" height="16" alt="Chart"/></a>
	<a href="<?php echo $this->base () ?>?page=drain-hole.php&amp;source=file&amp;chart=<?php echo $file->id ?>">view</a>
</td>
